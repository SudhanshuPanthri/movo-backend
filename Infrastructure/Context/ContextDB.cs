        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
{
    ...
    modelBuilder.Entity<Movie>()
        .Property(m => m.SerializedGenreIds) // Configure the new property
        .HasColumnType("nvarchar(max)") // Or any appropriate string type
        .IsRequired(false); // Adjust if it's nullable or not (depends on your design)
